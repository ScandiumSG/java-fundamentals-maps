...
public class Exercise extends ExerciseBase {
     ...
     */
    public boolean hasKey(HashMap<String, String> mapItem, String key) {
     ...
     */
    public int getValueOrDefault(HashMap<String, Integer> mapItem, String key) {
